...
namespace ET
{
	...
	public partial class EntryRandomConfig: ProtoObject, IConfig
	{
		...
		public int EntryMaxCount { get; set; }
		/// <summary>特殊词条最小数量</summary>
		public int SpecialEntryMinCount { get; set; }
		/// <summary>特殊词条最大数量</summary>
		public int SpecialEntryMaxCount { get; set; }
		/// <summary>词条等级</summary>
		public int EntryLevel { get; set; }
		/// <summary>特殊词条等级</summary>
