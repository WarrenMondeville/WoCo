...
namespace ET
{
    ...
    public partial class Other2UnitCache_GetUnit : MessageObject, IRequest
    {
        ...
        /// </summary>
        [MemoryPackOrder(2)]
        public List<string> ComponnetNameList { get; set; } = new();
    ...
    public partial class G2Chat_ExitChat : MessageObject, IRequest
    {
        public static G2Chat_ExitChat Create(bool isFromPool = false)
        {
            return ObjectPool.Instance.Fetch(typeof(G2Chat_ExitChat), isFromPool) as G2Chat_ExitChat;
        }
    ...
    public partial class Chat2G_ExitChat : MessageObject, IResponse
    {
        public static Chat2G_ExitChat Create(bool isFromPool = false)
        {
            return ObjectPool.Instance.Fetch(typeof(Chat2G_ExitChat), isFromPool) as Chat2G_ExitChat;
        }
    ...
    public static class InnerMessage
    {
        ...
        public const ushort G2M_RequestEnterGameState = 20037;
        public const ushort M2G_RequestEnterGameState = 20038;
